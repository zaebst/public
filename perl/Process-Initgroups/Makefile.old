# This Makefile is for the Process::Initgroups extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Process/Initgroups.pm]
#     AUTHOR => [q[dave <dave@>]]
#     BUILD_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I.]
#     LIBS => [q[]]
#     NAME => q[Process::Initgroups]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Process/Initgroups.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Process::Initgroups
NAME_SYM = Process_Initgroups
VERSION = 0.01
...
MAKE = make
FULLEXT = Process/Initgroups
BASEEXT = Initgroups
PARENT_NAME = Process
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Process/Initgroups.pm
INC = -I.
DEFINE = 
...
XS_FILES = Initgroups.xs
C_FILES  = Initgroups.c
O_FILES  = Initgroups.o
H_FILES  = ppport.h
MAN1PODS = 
MAN3PODS = lib/Process/Initgroups.pm
...
TO_INST_PM = lib/Process/Initgroups.pm

PM_TO_BLIB = lib/Process/Initgroups.pm \
	blib/lib/Process/Initgroups.pm
...
DISTNAME = Process-Initgroups
DISTVNAME = Process-Initgroups-0.01
...
# Process::Initgroups might depend on some other libraries:
...
manifypods : pure_all  \
	lib/Process/Initgroups.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Process/Initgroups.pm $(INST_MAN3DIR)/Process::Initgroups.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Process-Initgroups' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension to use the c function initgroups found on most linux like systems.' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - dave <dave@>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension to use the c function initgroups found on most linux like systems.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>dave &lt;dave@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Process/Initgroups.pm blib/lib/Process/Initgroups.pm 
